...
@Component({
  selector: 'app-employee-license',
  templateUrl: './employee-license.component.html',
  styleUrls: ['./employee-license.component.scss']
})
export class EmployeeLicenseComponent implements OnDestroy, OnInit {
